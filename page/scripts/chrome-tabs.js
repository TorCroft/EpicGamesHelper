((window, factory) => {
  ...
  class ChromeTabs {
    ...
    setupCustomProperties() {
      ...
      const tab_start_pos = totalExtraWidthDueToFlooring / 2
      const tab_total_width = totalTabsWidthUsingTarget
      this.el.style.setProperty('--tab-start-pos', `${tab_start_pos}px`)
      this.el.style.setProperty('--tab-total-width', `${tab_total_width}px`)
    }
